          ...
          <div className="container relative z-10">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-muted-foreground">
                Advanced motion-preserving treatment for cervical disc disease
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2">
                ...
                <p className="text-muted-foreground mb-8">
                  The procedure typically takes 1-2 hours, and most patients stay in the hospital for 1-2 days after surgery.
                </p>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-24 space-y-6">
                  <div className="card p-6 rounded-lg shadow-md bg-card">
                    <h3 className="text-xl font-semibold mb-3 text-primary">Is Cervical Disc Replacement Right for You?</h3>
                    <p className="text-muted-foreground mb-4">
                      While cervical disc replacement offers many benefits, it's not appropriate for everyone. Factors that may influence suitability include:
                    </p>
                    <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                      <li>Age and overall health</li>
                      <li>Extent and location of disc damage</li>
                      <li>Presence of cervical spine instability</li>
                      <li>Bone quality</li>
                      <li>Previous neck surgeries</li>
                    </ul>
                    <p className="text-muted-foreground mb-4">
